...
This document presents bivariate OLS regressions with country-level fixed effects only, and the country coefficients are hidden. Note that Pedagogical Knowledge as a school outcomes is excluded from analysis here because it is only captured in the Mozambique survey. Furthermore, the dataset used is slightly different than those in the past, as this dataset uses the World Bank Polygons to determine the location of observations. This results in a loss of about 40 school observations. I'm currently looking into what may be causing this. 
